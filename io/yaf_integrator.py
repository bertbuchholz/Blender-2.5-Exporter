...
class yafIntegrator:
    ...
    def exportIntegrator(self, scene):
        ...
        if light_type == "Direct Lighting":
            ...
            yi.paramsSetString("spherical_function_type", scene.intg_pbgi_spherical_fct_type)
            yi.paramsSetBool  ("variational",             scene.intg_pbgi_variational)
            yi.paramsSetBool  ("enable_conversion",       scene.intg_pbgi_enable_conversion)
            yi.paramsSetString("dictionary_type",         scene.intg_pbgi_dictionary_type)
            yi.paramsSetInt   ("dict_num_centers",        scene.intg_pbgi_dict_num_centers)
            yi.paramsSetFloat ("dict_sample_fraction",    scene.intg_pbgi_dict_sample_fraction)
